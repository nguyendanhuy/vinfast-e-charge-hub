        ...
        <div className="relative z-20 container mx-auto px-4 pt-20 pb-32">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to="/signup">
                <Button size="lg" className="bg-coral text-white hover:bg-coral/90 text-lg px-8 py-4 rounded-full shadow-xl">
                  ĐẶT DỊCH VỤ
                </Button>
              </Link>
            </div>
      ...
      <section className="py-20 bg-white" id="about">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <div className="text-coral text-lg font-medium mb-4 italic">Chào mừng bạn đến!</div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button variant="outline" className="border-coral text-coral hover:bg-coral hover:text-white px-8 py-3 rounded-full">
                  KHU DÂN CƯ
                </Button>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-50" id="services">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="text-coral text-lg font-medium mb-4 italic">Những dịch vụ của chúng tôi</div>
            <h2 className="text-4xl font-bold text-gray-800 mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="group hover:scale-105 transition-all duration-300 border-0 shadow-lg overflow-hidden">
              <div className="aspect-square bg-gradient-to-br from-coral to-orange-500 p-8 flex items-center justify-center">
      ...
      <section className="py-20 bg-gray-50" id="contact">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to="/signup">
                <Button size="lg" className="bg-coral text-white hover:bg-coral/90 text-lg px-12 py-4 rounded-full shadow-xl">
